...
impl Converter {
    ...
    pub fn glitchtip_to_feishu_card(&self, glitchtip: &GlitchTipSlackWebhook) -> FeishuWebhook {
        ...
        self.fallback_card_construction(glitchtip)
    }

    fn fallback_card_construction(&self, glitchtip: &GlitchTipSlackWebhook) -> FeishuWebhook {
        // Extract issue identifier from sections
        let issue_identifier = glitchtip.sections
            .first()
            .map(|section| section.activity_subtitle.strip_prefix("View Issue ").unwrap_or(&section.activity_subtitle))
            .unwrap_or("Unknown");
        ...
        if let Some(attachment) = glitchtip.attachments.first() {
            let exception_class_name = attachment.title.split(':').next().unwrap_or(&attachment.title);
            let full_error_message = &attachment.title;
            ...
            let card = serde_json::json!({
                ...
                "header": {
                    "title": {
                        "tag": "plain_text",
                        "content": format!("GlitchTip 报错告警 - {}", issue_identifier)
                    },
                    "template": "red",
                ...
                "body": {
                    ...
                    "elements": [
                        {
                            "tag": "markdown",
                            "content": format!("**<font color='red'>{}</font>**: {}", exception_class_name, full_error_message),
                            "text_align": "left",
                            "text_size": "normal_v2",
                            ...
                            "columns": [
                                {
                                    ...
                                    "elements": [
                                        ...
                                        {
                                            "tag": "markdown",
                                            "content": format!("<font color='{}'>{}</font>", project_fg, project_id),
                                            "text_align": "center",
                                            "text_size": "normal_v2"
                                        }
                                    ],
                                ...
                                },
                                {
                                    ...
                                    "elements": [
                                        ...
                                        {
                                            "tag": "markdown",
                                            "content": format!("<font color='{}'>{}</font>", env_fg, environment_name),
                                            "text_align": "center",
                                            "text_size": "normal_v2"
                                        }
                                    ],
                                ...
                                },
                                {
                                    ...
                                    "elements": [
                                        ...
                                        {
                                            "tag": "markdown",
                                            "content": format!("<font color='{}'>{}</font>", host_fg, hostname),
                                            "text_align": "center",
                                            "text_size": "normal_v2"
                                        }
                                    ],
                        ...
                        {
                            "tag": "markdown",
                            "content": format!("• **发布版本**: {}\n• **错误时间**: {}", commit_hash, current_timestamp),
                            "text_align": "left",
                            "text_size": "normal_v2",
                            "margin": "0px 0px 0px 0px"
                        }
            ...
            if !attachment.title_link.is_empty() {
                let button = serde_json::json!({
                    ...
                    "behaviors": [
                        {
                            "type": "open_url",
                            "default_url": attachment.title_link,
                            "pc_url": "",
                            "ios_url": "",
                            "android_url": ""
                        }
                ...
                if let Some(body) = card_with_button["body"]["elements"].as_array_mut() {
                    body.push(button);
                }
            }
